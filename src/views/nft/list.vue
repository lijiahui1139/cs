<template>
  <div class="app-container">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span v-if="scope.row.nftVerify == 0">{{
            $t("nftManagement.unauthenticated")
          }}</span>
          <span v-else-if="scope.row.nftVerify == 1">{{
            $t("nftManagement.certificationPassed")
          }}</span>
          <span v-else>{{ $t("nftManagement.authenticationFailed") }}</span>
      ...
      <el-table-column
        align="center"
        :label="$t('nftManagement.quantity')"
        prop="quantity"
        width="100px"
      />
      <el-table-column
        align="center"
        :label="$t('nftManagement.sellQuantity')"
        prop="sellQuantity"
        width="100px"
      />
      <el-table-column
      ...
      >
        <template slot-scope="scope">
          ...
          <el-link
            ...
            :underline="false"
            >{{ $t("nftManagement.immediateCertification") }}
          </el-link>
          <el-link
            class="ml-20"
            style="color: #40beb9"
          ...
          <el-button
            ...
            @click="cancelCertification(scope.row)"
            v-else
            >{{ $t("nftManagement.cancelCertification") }}</el-button
          > -->
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog
      :title="$t('nftManagement.authentication')"
  ...
  methods: {
    ...
    cancelCertification(row) {
      ...
      this.$confirm(this.$t("util.tipContent1"), this.$t("util.tip"), {
        ...
        that
          .$api("nft.verify", { id: row.id, nftVerify: 0 })
          .then((response) => {
