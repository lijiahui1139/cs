<template>
  <div class="dashboard-editor-container">
        ...
        <div class="ml-40 mb-20">
          ...
          <div class="half-table">
            ...
            <el-table :data="userCreate" border>
              <el-table-column
                prop="todayAdd"
                :label="$t('dashboard.todayAdd')"
              >
              </el-table-column>
              <el-table-column
                prop="beforeAdd"
                :label="$t('dashboard.yesterdayAdd')"
              >
              </el-table-column>
              <el-table-column
                prop="growth"
    ...
    <div class="revenue-container ml-40 mb-20">
      ...
      <span class="revenue">
        {{ $t("dashboard.platform") }}：<span>{{ totalPlatform }}ETH</span>
      </span>
      <span class="revenue">
        {{ $t("dashboard.profit") }}：<span class="green"
          >{{ totalProfit }}ETH</span
        >
      </span>
      <span class="revenue">
        {{ $t("dashboard.gas") }}：<span class="red">{{ totalGas }}ETH</span>
      </span>
    </div>
    ...
    <div>{{ $t("dashboard.nftManagement") }}</div>
    <div class="revenue-container ml-40 mb-20">
      <div class="revenue">
        {{ $t("dashboard.totalNft") }}：<span class="green"
          >{{ countNFT }}</span
        >
      </div>
      <div class="revenue">
