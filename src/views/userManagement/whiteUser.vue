  ...
  <div class="app-container">
    <div class="filter-container">
      <el-input
        ...
        :placeholder="$t('whiteUser.placeholder')"
      />
      <el-button
        class="filter-item"
        type="primary"
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          :loading="apiLoading"
          type="primary"
          @click.native.prevent="handlerConfirm"
          >{{ $t("whiteUser.confirm") }}</el-button
        >
      </span>
    </el-dialog>
  </div>
