      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span v-if="scope.row.userVerify == 0 || !scope.row.userVerify">{{
              $t("userData.unauthenticated")
            }}</span>
            <span v-if="scope.row.userVerify == 1">{{
              $t("userData.certificationPassed")
            }}</span>
            <span v-if="scope.row.userVerify == 2">{{
        ...
        >
          <template slot-scope="scope">
            ...
            <el-link
              ...
              :underline="false"
              >{{ $t("userData.immediateCertification") }}
            </el-link>
            <el-link
              class="widthFit"
              style="color: #13ce66"
