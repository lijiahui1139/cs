  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button
        ...
        type="primary"
        @click="handleCreate"
        >{{ $t("systemManagement.add") }}</el-button
      >
      <el-button
        :loading="downloadLoading"
        class="filter-item"
        @click="handleDownload"
        >{{ $t("systemManagement.export") }}</el-button
      >
    </div>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      this.$confirm(this.$t("whiteUser.deleteTip"), this.$t("global.tip"), {
    ...
    handleDownload() {
      ...
      import("@/vendor/Export2Excel").then((excel) => {
        const tHeader = [
          this.$t("systemManagement.administratorID"),
          this.$t("systemManagement.administratorName"),
          this.$t("systemManagement.administratorAvatar"),
        ];
